...
DCOCTL = CALDCO_1MHZ;
FCTL2 = FWKEY + FSSEL0 + FN1; // MCLK/3 for Flash Timing Generator__no_operation(); // Place breakpoint here, observe 0x1040
FCTL3 = FWKEY; // Clear Lock bit
FCTL1 = FWKEY + WRT; // Set WRT bit for write operation*
Flash_ptr = 0xAA; // Write value to flash
__no_operation(); // Place breakpoint here, observe 0x104030*
